<section>
    ...
    <p align='justify'>Pada pengertian codeigniter di atas 
        tadi di jelaskan bahwa codeigniter mengunakan metode MVC. Apa itu 
        ...
        controller.</p>
                    ...
                    <ol type='a'>
                    <li>Model</li>
        <p align='justify'>adalah kelas yang merepresentasikan atau
        ...
        letakkan di dalam model.</p>
        <p align='justify'>Sebagai contoh, jika ingin membuat aplikasi
        ...
        mendesign tampilann aplikasi, karena back-end developer menangani 
